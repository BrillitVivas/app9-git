...
function WatchPosition(){
	...
	function onSuccess(position){
		...
		$('#longitude').html(position.coord.longitude);
		$('#altitud').html(position.coord.altitud);
		$('#accuracy').html(position.coord.accuracy);
		$('#aaccuracy').html(position.coord.aaccuracy);
		$('#headingg').html(position.coord.headingg);
		$('#speed').html(position.coord.speed);
		$('#timestamp').html(position.coord.timestamp);
		};
